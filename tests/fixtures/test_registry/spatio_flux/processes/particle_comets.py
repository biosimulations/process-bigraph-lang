...
import numpy as np
from tests.fixtures.test_registry.spatio_flux.processes.dfba import get_spatial_dfba_state
...
def get_particle_comets_state(
    ...
    field_interactions: dict[str, Any] | None = None,
    ...
    composite_state = get_spatial_dfba_state(n_bins=n_bins, mol_ids=mol_ids, initial_min_max=initial_min_max)
